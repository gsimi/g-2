...
namespace PS4000aSigGen
{
    partial class AWG_SIGGEN
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.awg_label2.Text = "Please make sure that the  file only has one value per line, in ADC values";
            ...
            this.awg_label.Text = "Please enter file  name (don\'t forgot the .txt extension):";
