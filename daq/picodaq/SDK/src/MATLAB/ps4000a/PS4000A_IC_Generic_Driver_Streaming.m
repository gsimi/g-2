%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Filename:    PS4000A_IC_Generic_Driver_Streaming
%
...
%   PicoScope 4000 Series (A API) Instrument Control Toobox driver to 
...
%       same directory or define the path in the PS4000aConfig.m file:
%       
%       - picotech_ps4000a_generic.mdd
%       - ps4000a.dll & ps4000aWrap.dll 
%       - ps4000aMFile.m & ps4000aWrapMFile.m
%       - PicoConstants.m
%       - PicoStatus.m
%       - Functions
%
%   Device used to generated example: PicoScope 4824
%
%   History:
%
%   Oct-14 - Initial example
%   14-Nov-14 - modified to support PicoScope 4225 and 4425
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% ps4000aRunStreaming will output the actual sampling interval used by the 
% driver.
