 ...
 *	add HRDLbc.lib to the project (Borland C only)
 *	add HRDL.lib to the project   (Microsoft C only)
 *	build the project
 *
 *
 ***************************************************************************/
...
*
* SelectUnit
*  this function demonstrates how to open all avaiable units and
...
int16_t SelectUnit(void)
{
	...
	printf("\n\nOpen devices Asynchronously?"); 
	async = 1;//(int16_t) toupper (_getch ()) == 'Y';
...
{ 
	...
	g_doSet = FALSE;
	printf("HRDL driver example program\n");
	printf("Version 1.1\n");
	printf("Copyright 2004 - 2015 Pico Technology Ltd\n");
