...
int main(int argc, char *argv[])
{
  ...
  */
  ...
  uint32_t enabled_channels[3] = {   0x00fc,  0x00f4 , 0x00c0}; // 0 --> trg   1 --> signal // *** non funziona il segnale sul canale 10, ora bypassato  
  // 0011 0101 0000 0000
  // 3    5    0    0
  ...
  //  uint32_t veto_mask = 0x0000;  //mask of veto channels
   uint32_t veto_mask[3] = { 0x00c0, 0x00c0, 0x0000};  //mask of veto channels
