...
int main(int argc, char *argv[])
{
  ...
  */
  ...
  #define nch  6
  int channel[nch]  =  {3,4,5,6,7,8};  //channel=[1:16]
  ...
  uint32_t enabled_channels[3] = {   0x00f0,  0x000c , 0x00fc }; // 0 --> trg   1 --> signal // *** non funziona il segnale sul canale 10, ora bypassato  
  // 0011 0101 0000 0000
  // 3    5    0    0
  ...
  //  uint32_t veto_mask = 0x0000;  //mask of veto channels
   uint32_t veto_mask[3] = { 0x0000, 0x000c, 0x000c};  //mask of veto channels
  ...
  */
  ...
  float tdelay[nch]      =  {
			     ...
			     45.0 + 10*2.75, 
  				 45.0 + 27*2.75,
			     45.0 + 27*2.75, 
			     45.0 + 27*2.75, //canali efficienza
			     45.0 + 27*2.75
  ...
  //float vetowidth=80; //340 ns cambiato da noiiiiiiiiiiiiii
  //float vetowidth=50;
  //float vetowidth=100;
  float vetowidth =75;
