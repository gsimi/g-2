...
int main(int argc, char *argv[])
{
  ...
  */
  ...
  #define nch  6
  //int channel[nch]  =  {9,10,11,12,13,14};  //channel=[1:16] C=3,4  E=5,6 F=7,8
  ...
  uint32_t enabled_channels[3] = {   0x008c,  0x0031 , 0x0035 }; // 0 --> trg   1 --> signal // *** non funziona il segnale sul canale 10, ora bypassato  
  // 0011 0101 0000 0000
  // 3    5    0    0
  ...
  */
  ...
  float tdelay[nch]      =  {45.0 + 20*2.75,
			     ...
			     45.0 + 10*2.75, 
			     45.0 + 10*2.75, 
			     45.0 + 20*2.75, //canali efficienza
			     45.0 + 20*2.75};//canali efficienza [ns] 
...
/*
  ...
  */
  ...
  // veto generation
  // enable channels
  int veto_offset=0x1c;// 0x14=VETO1, 0x18=VETO2, 0x1C=VETO3
