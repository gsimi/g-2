...
int main(int argc, char *argv[])
{
  ...
  */
  ...
  /*
    ...
    Read 256 bytes
    configurig chanel 2
    write in 0x801004 value 0x1f7 : treshold -50mv
  ...
  */
  ...
  uint32_t enabled_channels[3] = {   0x1c00,  0xdc00 , 0xc000 }; // 0 --> trg   1 --> signal // *** non funziona il segnale sul canale 10, ora bypassato  
  ...
  uint32_t veto_mask = 0xc000;  //mask of veto channels
  ...
  */
  ...
  float tdelay[nch]      =  {45.0 + 5*2.75,
			     45.0 + 45*2.75,
			     45.0 + 45*2.75, 
			     45.0 + 45*2.75, 
			     45.0 + 5*2.75, //canali efficienza
			     45.0 + 5*2.75};//canali efficienza [ns] 

  //  range [10ns:1173ns] in 4.56ns steps
//  float adcwidth=33; //  160ns
  float adcwidth=15; //  78.5ns
  float vetowidth=43; //206ns
  float width[nch]       =  {10.1 + vetowidth*4.56,
			     10.1 + adcwidth*4.56,
			     10.1 + adcwidth*4.56,
			     10.1 + adcwidth*4.56,
			     10.1 + vetowidth*4.56,
